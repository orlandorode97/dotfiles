...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    config = { "\27LJ\2\n)\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\14git-blame\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/orlando.romo/.local/share/nvim/site/pack/packer/opt/git-blame.nvim",
